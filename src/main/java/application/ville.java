...
class Test2 {
    public static void main(String[] args) {
        ...
        System.out.print("bienvenue dans le jeu ! vous souhaitez quels type de personnage?:1-Standard,2-Hippie,3-pressé:");
        ...
        avignon.afficher();
        System.out.print("Votre personnage demarre a la Case [0][0] , A vous de jouer \n");
